     ...
     //date 지정 시작일과 끝
      ...
      function initFormStudent(object){
    	 ...
    	 if( object == "" || object == null || object == undefined){
    	  ...
    	  $("#loginaddr").val("");//post
    	  $("#loginaddr1").val("");//addr
    	  $("#detailaddr").val("");//addr detail
    	  $("#enr_date").val("");//pw
    	  $("#lec_seq").attr("readonly", false);
    	  ...
    	  $("#btnDelete").hide();
    		 ...
    		 var info = object['0'];
    	  $("#task_seq").val(info.name);//name
       	  $("#lec_seq").val(info.loginID);//id
       	  $("#lec_nm").val(info.password);//pw
       	  $("#task_nm").val(info.password);//pw_re
       	  $("#loginaddr").val(info.user_post);//post
       	  $("#loginaddr1").val(info.user_addr);//addr
       	  $("#detailaddr").val(info.addr_detail);//addr detail
       	  $("#enr_date").val(info.user_email);//pw
    	  $("#lec_seq").attr("readonly", true);
    	  $("#lec_seq").css("background","FFFFFF");
    	  $("#st_name").focus();
					...
					<li class="contents">
						...
						<div>
							<p class="Location">
								...
								<tbody>
									...
									<td><input type="text" style="height: 31px; width: 110px;" class="txtInput" id="fromDt" name="fromDt" ></td>
									<td><span><b>&nbsp ~ &nbsp</b></span></td>
									<td><input type="text" style="height: 31px; width: 110px" class="txtInput" id="toDt" name="toDt"></td>
									</tr>
									<tr><td><span>학생명 : </span></td>
									<td colspan="4" ><input type="text" style="height: 31px;" id="searchTxt" name="searchTxt" class="txtInput">
									<span width="110" height="60" style="font-size: 120%"> 
							   
							   <a href="javascript:selectUserInfoList()" class="btnType gray"  id="btnSearch" name="btn"><span>검색</span></a>
							</span>
									</td>
									</tr>
								</tbody>
							  ...
							  <table class="col" style="width: 1003px;">
									...
									<thead>
										<tr>
											...
											<th class="th_info" ><input type="checkbox" style="width: 24px; height: 24px;" id="allChk" onclick="allCheckYn(this,'list1Check')"></th>
											<th class="th_info" data-field="index" >순번</th> 
											<th class="th_info" data-field="name" >이름</th>	<!-- name  -->
											<th class="th_info" data-field="status_yn" >상태</th>	<!-- status_yn  -->
											<th class="th_info" data-field="password" >비밀번호</th><!-- password   -->
											<th class="th_info" data-field="user_email" >이메일</th><!-- email  -->
						...
						<div>
							<p class="conTitle" style=" float: right; border: none;">
								<span>
								<a class="btnType blue" href="javascript:fRegister1()" name="modal" style="background: none;">
								  <span>신규등록</span></a>
								  </span>
								  <span>
								<a class="btnType blue" href="javascript:f_processUserInfo('list')" name="modal" style="background: none;">
								  <span>대량 데이터 처리(테스트)</span></a>
								  </span>
								  <!-- <span>
