...
/* 			if(!ValidateLssCod()){
		...
		//단건조회
		function selectDetailLss(ldo_seq){
				...
				<li class="contents">
					...
					<div class="content">
						...
						<span class="fr"> <a class="btnType blue"
							href="javascript:fWriterLecDoc();" name="modal"><span>학습자료등록</span></a>
						</span> <br>
						<div></div>
						<!-- <div>
