...
<script type="text/javascript">
	...
	function fcnsList(currentPage) {
		...
		callAjax("/mss/cnsList.do", "post", "text", true, param, resultCallback);
	}
	//과정콜백
	function fcnsListResult(data, currentPage) {
		...
		var $totalCntlist = $data.find('#totalCntlist');
		var totalCntlist = $totalCntlist.text();
	...
	function fcnsUserList(currentPage, lec_seq, lec_nm) {
		...
		callAjax("/mss/cnsUserList.do", "post", "text", true, param,
				resultCallback);
	}
	//유저 뽑기 콜백
							...
							<div class="divCnsUserDtlList">
								<table class="col">
									...
									<tbody id="cnsUserDtlList">
										<tr>
											<td colspan="12">학생이름을 클릭하여 상담해주세요.</td>
										</tr>
									</tbody>
								</table>
							</div>
