...
function fupdateQna(){
	...
	$("#action2").val("U");
	$("#dqna_seq").val(ved.qna_seq);
	$("#dqna_contents").val(ved.qna_contents);
	var frm = document.getElementById("detailQna");
	frm.enctype = 'multipart/form-data';
	var fileData = new FormData(frm);
	...
	upOV = new Vue({
		...
		methods:{
			...
			deleteQna:function(){
    	     ...
    	     saveQnaBtn:function (){
    	    	 if(this.enr_user != '${sessionScope.loginId}'){
    	    		 alert("수정할 수 없습니다.")
    	    	 }else{
    	    		 fupdateQna();
    	    	 }
...
<body>
										...
										<table id="vuedatatable" class="col2 mb10" style="width: 1000px;">
											...
											<tbody>
												...
												<tr onclick="vm.rowClicked(this)">
													...
													<td>{{ index + 1}}</td>
													<td>{{ row.qna_title }}
													<img v-if="row.file_nm !='' & row.file_nm != null"
	...
	<div id="noticevue" class="layerPop layerType2" style="width: 1000px; hight: 1000px;">
		...
		<input type="hidden"  name="qna_contents" id="dqna_contents"  value="">
		<input type="hidden"  name="qna_seq" id="dqna_seq"  value="">
		<!-- 수정시 필요한 num 값을 넘김  -->
		...
		<dl>
			...
			<dd class="content">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="5">
									...
									<div v-if="file_nm !='' & file_nm != null"  id="filearea">
										<img src="/images/treeview/file.gif" name="file_nm"id="dfile_nm" @click="fDownloadQnaFileEvent">
										<span >{{file_nm}}</span>
										&nbsp;&nbsp;
										<img v-if="mOk"  src="/images/treeview/minus.gif" @click="minusClickEvent">
									</div>
									<div v-else>
										<input type="file" name="file_nm" id="dfile_nm"  ></input><!-- @change="filenameset" -->
				...
				<div class="btn_areaC mt30" id="updateOption">
						...
						<a v-if="enr_user == '${sessionScope.loginId}' & option"  class="btnType blue" @click="saveQnaBtn"><span>저장</span></a>
					...
					<table class="row" id="studentQnawriteFromID">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="5">
									<!--multiple="multiple" -->
									<input type="file" name="file_nm" id="wfile_nm"  @change="filenameset"></input>
									<img v-if="file_nm !='' "src="/images/treeview/minus.gif" @click="minusClickEvent">
