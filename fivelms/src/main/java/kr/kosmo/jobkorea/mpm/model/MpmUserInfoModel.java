...
public class MpmUserInfoModel {
	...
	public String toString() {
		return "MpmUserInfoModel [loginID=" + loginID + ", password=" + password + ", name=" + name + ", user_type="
				+ user_type + ", user_email=" + user_email + ", user_addr=" + user_addr + ", addr_detail=" + addr_detail
				+ ", user_post=" + user_post + ", user_joinDate=" + user_joinDate + ", status_yn=" + status_yn
				+ ", regUserId=" + regUserId + ", act_mode=" + act_mode + ", fileNm=" + fileNm + ", filePath="
				+ filePath + "]";
	}
